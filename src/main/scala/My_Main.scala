...
object My_Main {
  def main(args: Array[String]): Unit = {
    ...
    val data = sc.textFile("file:///C://Users//Kulinar//Desktop//PythonProjects//parse_html//languages2.csv").map { idx => idx.toLowerCase }
    val junk = data.first()
...
//    val startTime = LocalDateTime.now()
    ...
    val posts = sc.textFile("file:///C://Users//Kulinar//Desktop//big_data//data//posts_sample.xml")
